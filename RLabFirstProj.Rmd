...
<div dir="rtl">
  <h2 style="font-size: 20px;">مقدار چولگی مثبت است پس یعنی داده ها چولگی به سمت راست دارند این چیزی است که هیستوگرام هم به ما تقریبا نشان می دهد همچنین داده ها کشیدگی کمتری از داده های نرمال(3) دارند</h2>
</div>
